function selectOption(option) {
    ...
    if (option === 1) {
        ...
        inputOutputArea.innerHTML = `
            <h2>方案2 输入变量</h2>
            <div>
                <label>垂直总长度 h:</label><input type="number" id="h2"><br>
                <label>左端到第一尖点 L1:</label><input type="number" id="L12"><br>
                <label>第二尖点到右端 L2:</label><input type="number" id="L22"><br>
                <label>铜排厚度 T:</label><input type="number" id="T2"><br>
            </div>
        ...
        inputOutputArea.innerHTML = `
            <h2>方案3 输入变量</h2>
            <div>
                <label>水平总长度 L:</label><input type="number" id="L3"><br>
                <label>左端到第一尖点 L1:</label><input type="number" id="L13"><br>
                <label>第一尖点到右端 L2:</label><input type="number" id="L23"><br>
                <label>铜排厚度 T:</label><input type="number" id="T3"><br>
            </div>
        ...
        inputOutputArea.innerHTML = `
            <h2>方案4 输入变量</h2>
            <div>
                <label>水平总长度 L:</label><input type="number" id="L4"><br>
                <label>垂直总长度 h:</label><input type="number" id="h4"><br>
                <label>左端到第一尖点 L1:</label><input type="number" id="L14"><br>
                <label>第二尖点到右端 L2:</label><input type="number" id="L24"><br>
                <label>铜排厚度 T:</label><input type="number" id="T4"><br>
            </div>
        ...
        inputOutputArea.innerHTML = `
            <h2>方案5 输入变量</h2>
            <div>
                <label>水平总长度 L1:</label><input type="number" id="L51"><br>
                <label>水平长度 L2:</label><input type="number" id="L52"><br>
                <label>垂直总长度 h:</label><input type="number" id="h5"><br>
                <label>垂直长度 h1:</label><input type="number" id="h51"><br>
                <label>垂直长度 h2:</label><input type="number" id="h52"><br>
                <label>铜排厚度 T:</label><input type="number" id="T5"><br>
            </div>
        ...
        inputOutputArea.innerHTML = `
            <h2>方案6 输入变量</h2>
            <div>
                <label>输入变量1:</label><input type="number" id="var1"><br>
                <label>输入变量2:</label><input type="number" id="var2"><br>
                <label>铜排厚度 T:</label><input type="number" id="T6"><br>
            </div>
...
function calculateOption1() {
    ...
    document.getElementById('output').innerHTML = `
        <h3>输出变量</h3>
        <p>折弯内角 α: ${alpha.toFixed(2)}°</p>
        <p>折弯扣除数 BD: ${BD.toFixed(2)}</p>
        <p>折弯内径 R: ${R}</p>
        <p>铜排展开长度 L展: ${L展.toFixed(2)}</p>
        <p>第一折弯线位置 M1: ${M1.toFixed(2)}</p>
        <p>第二折弯线位置 M2: ${M2.toFixed(2)}</p>
    `;
}
...
function calculateOption4() {
    ...
    document.getElementById('output4').innerHTML = `
        <h3>输出变量</h3>
        <p>折弯内角 α: ${alpha.toFixed(2)}°</p>
        <p>折弯内角 β: ${beta.toFixed(2)}°</p>
        <p>折弯扣除数 BD1: ${BDα.toFixed(2)}</p>
        <p>折弯扣除数 BD2: ${BDβ.toFixed(2)}</p>
        <p>折弯内径 R: ${R}</p>
        <p>铜排展开长度 L展: ${L展.toFixed(2)}</p>
        <p>第一折弯线位置 M1: ${M1.toFixed(2)}</p>
        <p>第二折弯线位置 M2: ${M2.toFixed(2)}</p>
